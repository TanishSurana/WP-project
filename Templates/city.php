            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <?php
                    ...
                    if(!isset($_SESSION["uid"]))
                    {
                        ...
                        echo "<a class='nav-link' href='#' onclick='$alert'>My Complaints</a>";
                    }
                    else{
                        echo "<a class='nav-link' href='mycomplaints.php'>My Complaints</a>";
                    }
                ?>
                ...
                <?php
                    ...
                    {
                        $alert = 'alert("login required!")';
                        echo "<a class='nav-link' href='#' onclick='$alert'>New Complaint</a>";
                    }
                    else{
                        echo "<a class='nav-link newcomplain' href='#'>New Complaint</a>";
                    }
                ?>
                </li>
                </ul>
    ...
    <main>
        ...
        <nav class="forum-nav stickynav">
                ...
                <div class="row" style="padding: 0; margin: 0;">
                    <div class="col-lg-3 col-sm-6 forum-element" style="padding: 0; margin: 0;">
                    ...
                    <div class="col-lg-3 col-sm-6 forum-element selected" style="padding: 0; margin: 0;">
                        <a href="city.php" style="padding: 0; margin: 0;">City</a>
                    </div>
                </div>
        </nav>
        ...
        <div class="container">
            <div class="imghead" style='background-image: url("../static/nyc.jpg")'>
                <div class="link-img">
                    City
                </div>
            </div>
        ...
        <div class="container">
            ...
            <?php
                ...
                $sql = "SELECT * FROM Complain WHERE Ran='$range' ORDER BY Votes DESC; ";
                $flag = 0;
           ...
           { 
                          ...
                          {     
                            ...
                            if($re1 = mysqli_query($link, $sql2))
                            {
                                if(mysqli_num_rows($re1)>0)
                                {
                                    ...
                                    <div class='complaint'>
                                        <div class='row'>
                                            <div class='col-lg-1 col-sm-12 upvotes'>";
                                                if(!isset($_SESSION['uid']))
                                                {
                                                    echo "<form action='#' method='post' onsubmit='$alert'>
                                                                <input type='text' name ='cid' style='display: none;' value='$cid'>
                                                                <button type='submit' style='color: lightgray;'><i class='fa fa-chevron-up'></i></button>
                                                            </form>";
                                                }
                                                else
                                                {
                                                    echo "<form action='updatecomplain.php' method='post'>
                                                                <input type='text' name ='cid' style='display: none;' value='$cid'>
                  ...
                  if($flag == 0)
                  {
                    echo "<p>No complaints in your range</p><br>";
                    }
            }
